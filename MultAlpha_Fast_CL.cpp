/*
	...
	command line string input (individual symbols in range [1,...,k_sym])
	...
	<symbol string> should be a string of numbers, each in the range [1,...,k_sym]; nb: this expects the values in symbol_string to be in the valid range--it does not check this beforehand--if there is an error, it will give an error message
