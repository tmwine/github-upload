function BinAlpha_Mx_Gen(mx_sz,d_1,d_2,delta,p_and_s)

%{

	generates and offers to save the {M0*P,M1*P,P} matrix set for binary alphabets ({0,1})
	...
	outputs:
	this has the option to save the resulting {M_1*P,M_2*P,P} matrix set in a .bin file
...
for i=1:2
	...
	% write the pad matrix, P
mx_wrt = conj(P'); % this to render matrix in row-major form in the bin file
